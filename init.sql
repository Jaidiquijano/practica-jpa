...
-- =========================================
DROP TABLE IF EXISTS personas_excursiones;
DROP TABLE IF EXISTS excursiones;

-- =========================================
-- 2. Crear tabla EXCURSIONES
-- =========================================
...
-- =========================================
-- 3. Insertar 30 registros en EXCURSIONES
-- =========================================
INSERT INTO excursiones (titulo, ciudad, duracion, precio)
VALUES ('Free tour por el centro histórico', 'Madrid', 120, 0.00),
       ('Visita al Museo del Prado', 'Madrid', 150, 25.50),
       ('Ruta de tapas por La Latina', 'Madrid', 180, 35.00),
       ('Tour modernista por el Eixample', 'Barcelona', 120, 22.00),
       ('Visita a la Sagrada Familia', 'Barcelona', 90, 30.00),
       ('Paseo por el Barrio Gótico', 'Barcelona', 120, 18.00),
       ('Tour por el casco antiguo', 'Sevilla', 120, 20.00),
       ('Crucero por el Guadalquivir', 'Sevilla', 90, 27.00),
       ('Visita a la Alhambra', 'Granada', 210, 40.00),
       ('Paseo por el Albaicín y Sacromonte', 'Granada', 150, 25.00),
       ('Tour por la Ciudad de las Artes', 'Valencia', 120, 19.50),
       ('Ruta de paella y arroces', 'Valencia', 150, 32.00),
       ('Excursión a Toledo desde Madrid', 'Toledo', 480, 55.00),
       ('Excursión a Segovia y Ávila', 'Segovia', 540, 65.00),
       ('Ruta de vinos por La Rioja', 'Logroño', 360, 70.00),
       ('Visita al Museo Guggenheim', 'Bilbao', 120, 28.00),
       ('Tour por la ría y casco viejo', 'Bilbao', 150, 24.00),
       ('Ruta de pintxos por el centro', 'San Sebastián', 150, 38.00),
       ('Excursión a Montserrat', 'Barcelona', 420, 60.00),
       ('Tour nocturno misterios y leyendas', 'Madrid', 120, 17.00),
       ('Tour en bicicleta por el río', 'Zaragoza', 150, 21.00),
       ('Ruta histórica por Córdoba', 'Córdoba', 150, 23.00),
       ('Visita a la Mezquita-Catedral', 'Córdoba', 90, 26.00),
       ('Excursión a Ronda y pueblos blancos', 'Málaga', 540, 75.00),
       ('Tour por el centro histórico', 'Málaga', 120, 19.00),
       ('Ruta de miradores y atardecer', 'Lisboa', 180, 29.00),
       ('Tour por el barrio de Belém', 'Lisboa', 150, 27.00),
       ('Visita al Coliseo y Foro Romano', 'Roma', 180, 45.00),
       ('Tour por el París iluminado', 'París', 150, 50.00),
       ('Crucero por el Sena', 'París', 90, 35.00);

-- =========================================
-- 4. Crear tabla PERSONAS_EXCURSIONES
-- =========================================
CREATE TABLE personas_excursiones
(
    id           BIGSERIAL PRIMARY KEY,
    ...
    edad         INTEGER,
    excursion_id BIGINT       NOT NULL REFERENCES excursiones (id) ON DELETE CASCADE
);

-- =========================================
-- 5. Insertar PERSONAS (10 por excursión, datos fijos)
--     Nombres y apellidos con sentido,
--     países variados, edad 18–79
-- =========================================
INSERT INTO personas_excursiones (nombre, apellidos, pais, edad, excursion_id)
VALUES
-- Excursión 1 (id = 1)
